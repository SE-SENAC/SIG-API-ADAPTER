...
let MatriculasController = class MatriculasController {
    gerarLinkUseCase;
    constructor(gerarLinkUseCase) {
        this.gerarLinkUseCase = gerarLinkUseCase;
    }
    async gerarLinkProcessarDados(req, res) {
...
exports.MatriculasController = MatriculasController = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)('IGerarLinkMatriculaUseCase')),
